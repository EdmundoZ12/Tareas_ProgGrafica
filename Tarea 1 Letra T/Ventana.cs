...
namespace Introduccion
{
    public class Ventana : GameWindow
    {
        ...
        protected override void OnLoad()
        {
            ...
            float[] vertices = new float[]
            {
                ...
                -0.5f,  0.5f, 0f,   // Vertice 0
                 ...
                 0.5f,  0.3f, 0f,   // Vertice 2
                -0.5f,  0.3f, 0f,   // Vertice 3

                // Parte vertical de la "T"
                -0.1f,  0.3f, 0f,   // Vertice 4
                 0.1f,  0.3f, 0f,   // Vertice 5
                 0.1f, -0.5f, 0f,   // Vertice 6
                -0.1f, -0.5f, 0f    // Vertice 7
            };
        ...
        protected override void OnRenderFrame(FrameEventArgs args)
        {
            ...
            // Dibuja las líneas para formar la "T"
            GL.DrawArrays(PrimitiveType.LineLoop, 0, 4); // Parte superior de la "T"
            GL.DrawArrays(PrimitiveType.LineLoop, 4, 4); // Parte vertical de la "T"
